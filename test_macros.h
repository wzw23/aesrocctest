...
test_ ## testnum: \
    ...
    beq testreg, x7, continue_test_ ## testnum; \
    call fail; \
continue_test_ ## testnum:
...
#define TEST_DATA
                                                        ...
                                                        //----5----|----5----|----5----|
#define DATA_TYPE_MASK (0)                              //data_type| reg_idx |   cnt
#define DATA_TYPE_OLD_VD (1)                            //...
#define DATA_TYPE_VS1 (2)                               //...
#define DATA_TYPE_VS2 (3)                               //...
#define DATA_TYPE_VD (4)                                //...
#define DATA_TYPE_RD (5)                                //data_type| reg_idx |    0
#define DATA_TYPE_FD (6)                                //...
#define DATA_TYPE_RS1 (7)                               //...
#define DATA_TYPE_FS1 (8)                               //...
#define DATA_TYPE_VL_LMUL_SEW_MA_TA (9)                 //data_type|    0    |    vm
#define DATA_TYPE_VSTART (10)                           //data_type|    0    |    0
#define DATA_TYPE_IMM  (11)                             //data_type|    0    |   imm
#define DATA_TYPE_UIMM  (12)                            //data_type|    0    |   uimm
#define MAX_DATA_TYPE_CNT (13)

#define OUTPUT_VREG(type,idx,cnt) \
  lui  x0, (((type & 0x1F) << 10) | ((idx & 0x1F)<< 5) | (cnt))
